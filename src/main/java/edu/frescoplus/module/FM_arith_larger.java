...
/*Module: FM_arith_larger
* if the input is larger than predefined integer, output true. 
* Author: Lei Xu
* Email: xray2012@email.tamu.edu 
*/

public class FM_arith_larger extends AFP_Module {
	...
	public FM_arith_larger(FP_LibFloodlight lib, String id, String type,
