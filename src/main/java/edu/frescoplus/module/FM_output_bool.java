...
/*Module: FM_output_bool
* output a boolean value according to predefined logic
* Author: Lei Xu
* Email: xray2012@email.tamu.edu 
*/

public class FM_output_bool extends AFP_Module {
	...
	public FM_output_bool(FP_LibFloodlight lib, String id, String type,
			String event, String[] pars, String[] inputs) {
		super(lib, id, type, event, pars, inputs, NUM_INPUT, NUM_OUTPUT);
		
		outputPar = Boolean.parseBoolean(pars[0]);
	}
