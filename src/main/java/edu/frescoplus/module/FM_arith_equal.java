...
/*Module: FM_arith_equal
* if the input is equal to predefined integer, output true. 
* Author: Lei Xu
* Email: xray2012@email.tamu.edu 
*/


public class FM_arith_equal extends AFP_Module {
	...
	public FM_arith_equal(FP_LibFloodlight lib, String id, String type,
