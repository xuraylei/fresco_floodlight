...
/*Module: FM_op_and
* output a boolean operation to conduct "OR" upon two input boolean
* Author: Lei Xu
* Email: xray2012@email.tamu.edu 
*/

public class FM_logic_or extends AFP_Module {
	...
	public FM_logic_or(FP_LibFloodlight lib, String id, String type,
