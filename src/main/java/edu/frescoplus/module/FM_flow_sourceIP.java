...
/* Module: FM_flow_sourceIP
* select source IP address of incoming flow
* Author: Lei Xu
* Email: xray2012@email.tamu.edu 
*/

public class FM_flow_sourceIP extends AFP_Module {

	//descriptions about module
	private final static int NUM_INPUT = 0;
	private final static int NUM_OUTPUT = 1;
	
	public FM_flow_sourceIP(FP_LibFloodlight lib, String id, String type, String event, String[] pars, String[] inputs) {
