...
/* Module: FM_flow_destinationMAC
* select destination MAC address of incoming flow
* Author: Lei Xu
* Email: xray2012@email.tamu.edu 
*/

public class FM_flow_destinationMAC extends AFP_Module {

	//descriptions about module
	private final static int NUM_INPUT = 0;
	private final static int NUM_OUTPUT = 1;
	
	public FM_flow_destinationMAC(FP_LibFloodlight lib, String id, String type, String event, String[] pars, String[] inputs) {
